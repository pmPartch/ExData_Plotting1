...
par(mfrow = c(2,2), cex.lab=0.9) #plot row-major order in a 2x2 grid and reduce label font size to 90%
...
legend("topright",cex = 0.90,  lty=c(1,1,1), lwd=c(1,1,1), bty="n", 
       col = c("black","red","blue"), legend = c("Sub_meeting_1","Sub_meeting_2","Sub_meeting_3"))
